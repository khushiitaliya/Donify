...
export default function HomePage() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="relative overflow-hidden rounded-2xl p-8 mb-10 bg-gradient-to-r from-rose-700 via-red-600 to-orange-500 text-white shadow-xl">
        <div className="absolute -top-10 -right-10 w-40 h-40 bg-white/20 rounded-full blur-2xl"></div>
        <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-white/20 rounded-full blur-2xl"></div>
        <div className="relative z-10">
          <p className="text-xs uppercase tracking-[0.2em] text-rose-100 font-semibold mb-2">Live Blood Network</p>
          <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-3">Respond Faster. Save More Lives.</h1>
          <p className="text-rose-100 max-w-3xl mb-6">Donify connects hospitals and donors instantly with smart matching, one-time alerts, and rewards for life-saving actions.</p>
          <div className="flex flex-wrap gap-3">
            <Link to="/signup" className="px-5 py-3 rounded-lg bg-white text-red-700 font-bold hover:bg-rose-50">Join as Donor</Link>
            <Link to="/login" className="px-5 py-3 rounded-lg border border-white/70 text-white font-bold hover:bg-white/10">Login</Link>
          </div>
        </div>
      </div>
